/* gcore_mips64.c -- core analysis suite
 *
		       ...
		       unsigned int size, void *buf)
{
	...
	for (i = MIPS64_EF_R1; i <= MIPS64_EF_R31; i++) {
		...
		regs->gregs[i] = mains->regs[i - MIPS64_EF_R0];
	}

	regs->gregs[MIPS64_EF_LO] = mains->lo;
	regs->gregs[MIPS64_EF_HI] = mains->hi;
	regs->gregs[MIPS64_EF_CP0_EPC] = cp0->cp0_epc;
	regs->gregs[MIPS64_EF_CP0_BADVADDR] = cp0->cp0_badvaddr;
	regs->gregs[MIPS64_EF_CP0_STATUS] = mains->cp0_status;
	regs->gregs[MIPS64_EF_CP0_CAUSE] = cp0->cp0_cause;
...
static struct user_regset mips64_register[] = {
	[REGSET_GPR] = {
...
static const struct user_regset_view mips64_regset_view = {
	.name = "mips64",
	.regsets = mips64_register,
	.n = ARRAY_SIZE(mips64_register),
	.e_machine = EM_MIPS,
};
